...
<title>Controles Diarios de Limpieza Guardados</title>
...
<div class="container">
    ...
    <h2>
        ...
        Controles Diarios de Limpieza y Desinfección
    </h2>
    <a href="dashboard.php" class="btn-volver">⬅ Volver</a>

    <a href="control_diario.php" class="btn-nuevo">
        <i class="fas fa-plus"></i> Crear Nuevo Control Diario
    </a>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            if (!$result) {
                ...
                while ($row = odbc_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="editar_limpieza.php?id=<?= $row['id'] ?>" class="btn-editar">
                ...
                if (!$hay_datos) {
                    echo "<tr><td colspan='7' class='text-center'>No hay controles diarios guardados</td></tr>";
                }
            }
